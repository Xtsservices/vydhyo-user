...
const { addTest, getTestsByDoctorId, getAllTestsPatientsByDoctorID, updatePatientTestPrice, processPayment,getpatientTestDetails, addTestBulk, getAllTestsByDoctorId  } = require("../controllers/testController");
const router = express.Router();

router.post("/addtest", addTest);
router.post("/addtest/bulk", addTestBulk);
router.get("/getTestsByDoctorId/:doctorId", getTestsByDoctorId);
router.get("/getAllTestsByDoctorId/:doctorId", getAllTestsByDoctorId);
