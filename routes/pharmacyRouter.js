...
const { addMedInventory, addPrescription, getAllMedicinesByDoctorID, getAllPharmacyPatientsByDoctorID, pharmacyPayment } = require("../controllers/pharmacyController");
...
router.get("/pharmacyPayment/:patientId", pharmacyPayment);
